modarea <- function(x, y, m, xSD, mSD, K) {
  ...
  print(paste("b0: ", round(areaU,digits=4)),quote=FALSE)
  print(paste("b1: ", round(areaU,digits=4)),quote=FALSE)
  print(paste("b2: ", round(areaU,digits=4)),quote=FALSE)
  print(paste("b3: ", round(areaU,digits=4)),quote=FALSE)
  print("",quote=FALSE)
